/**
 * Created by zhaowei on 17/5/22.
 */
var theme = {
    getOneTheme: function (name) {
        var theme = false;
        for (var i in this.themes) {
            if (this.themes[i].name == name) theme = this.themes[1];
        }
        return theme;
    },
    themes: [
        {
            ...
            chartTheme: {
                ...
                // 默认色板
                color: [
                    '#91c7ae', '#2f4554', '#c23531', '#61a0a8', '#d48265',
...
theme.activeTheme=theme.themes[0];
